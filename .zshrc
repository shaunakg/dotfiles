...
export ZSH="/Users/shaunakg/.oh-my-zsh"
...
function enable_touchid_sudo {
  ...
  echo "Sudo via TouchID isn't enalbed (probably due to software update). Enter your password to write to pam_tid.so."
  echo "(Disable this in ~/.zshrc if you don't want it)"
